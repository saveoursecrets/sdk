...
use sos_protocol::{
    DiffRequest, DiffResponse, Merge, MergeError, PatchRequest,
    PatchResponse, ScanRequest, ScanResponse, SyncStorage,
};
use sos_sdk::{
    events::{
...
use sos_sync::{EventLogType, MergeOutcome, StorageEventLogs, SyncPacket};
