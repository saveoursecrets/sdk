...
pub enum Error {
    ...
    #[cfg(all(feature = "network-client", feature = "listen"))]
    /// Error converting a PEM file to a certificate.
    #[error("invalid certificate PEM file")]
    RustlsPemfile,

    #[cfg(all(feature = "network-client", feature = "listen"))]
    /// Error importing trust anchor from a certificate.
    #[error(transparent)]
    Webpki(#[from] webpki::Error),

    #[cfg(all(feature = "network-client", feature = "listen"))]
    /// Error generated by the rustls library.
    #[error(transparent)]
    ...
    /// Error generated by the websocket client when a domain is invalid.
    #[cfg(feature = "listen")]
    #[error(transparent)]
    WebSocketUrl(#[from] tokio_tungstenite::tungstenite::error::UrlError),

    /// Error generated by the websocket client when a scheme is not supported.
    #[cfg(feature = "listen")]
    #[error("websocket URL scheme is not supported")]
