...
abstract class Sos3Native {
  Future<int> simpleAdder({required int a, required int b, dynamic hint});
}

class Sos3NativeImpl extends FlutterRustBridgeBase<Sos3NativeWire>
    implements Sos3Native {
  factory Sos3NativeImpl(ffi.DynamicLibrary dylib) =>
      Sos3NativeImpl.raw(Sos3NativeWire(dylib));

  Sos3NativeImpl.raw(Sos3NativeWire inner) : super(inner);
...
/// generated by flutter_rust_bridge
class Sos3NativeWire implements FlutterRustBridgeWireBase {
  /// Holds the symbol lookup function.
  final ffi.Pointer<T> Function<T extends ffi.NativeType>(String symbolName)
      _lookup;

  /// The symbols are looked up in [dynamicLibrary].
  Sos3NativeWire(ffi.DynamicLibrary dynamicLibrary)
      : _lookup = dynamicLibrary.lookup;

  /// The symbols are looked up with [lookup].
  Sos3NativeWire.fromLookup(
