...
Or to test with the file system backend:

```
SOS_TEST_CLIENT_FS=1 cargo make test-command-line
```
...
```
cargo make test-cli
SOS_TEST_CLIENT_FS=1 cargo make test-cli
```
...
SOS_TEST_CLIENT_FS=1 cargo make test-shell
```
