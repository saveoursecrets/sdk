...
use crate::sdk::{signer::ecdsa::Address, vault::VaultId};
use axum::{
    body::BoxBody,
    http::StatusCode,
...
pub enum Error {
    ...
    /// Error generated when a folder is required.
    #[error("folder '{1}' does not exist in account '{0}'")]
    NoFolder(Address, VaultId),

    /// Error generated when an account should not already exist.
    #[error("account '{0}' already exists")]
    AccountExists(Address),

    /// Error generated when a folder should not already exists.
    #[error("folder '{1}' already exists in account '{0}'")]
    FolderExists(Address, VaultId),
