...
/// Errors generated by the RPC module.
#[derive(Debug, Error)]
pub enum Error {
    ...
    /// Error generated by the server module.
    #[cfg(feature = "server")]
    #[error(transparent)]
    Server(#[from] Box<crate::server::Error>),
}
...
#[cfg(feature = "server")]
impl From<crate::server::Error> for ResponseMessage<'_> {
    fn from(value: crate::server::Error) -> Self {
        ResponseMessage::new_reply::<()>(
            None,
            StatusCode::INTERNAL_SERVER_ERROR,
            Some(Err(Error::Server(Box::new(value)))),
        )
