...
pub enum Error {
    ...
    */
    ...
    /// Error generated by the networking client module.
    #[error(transparent)]
    NetClient(#[from] sos_net::client::Error),

    /// Error generated by the networking server module.
    #[error(transparent)]
    NetServer(#[from] sos_net::server::Error),
