...
export ACCOUNT_CONTACTS="../../fixtures/contacts.vcf"
...
export FILE_INPUT="../../fixtures/sample.heic"
export FILE_OUTPUT="../../target/demo/file-download.heic"

export ATTACH_INPUT="../../fixtures/test-file.txt"
export ATTACH_OUTPUT="../../target/demo/attachment-download.txt"
...
export MIGRATE_1PASSWORD="../../fixtures/migrate/1password-export.csv"
export MIGRATE_DASHLANE="../../fixtures/migrate/dashlane-export.zip"
export MIGRATE_BITWARDEN="../../fixtures/migrate/bitwarden-export.csv"
export MIGRATE_FIREFOX="../../fixtures/migrate/firefox-export.csv"
export MIGRATE_MACOS="../../fixtures/migrate/macos-export.csv"
